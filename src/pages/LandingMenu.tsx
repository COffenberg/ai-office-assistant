  ...
  return <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-body text-muted-foreground max-w-2xl mx-auto">Choose how you'd like to work today. Access our learning platform, call analyzer or chat with our AI assistant.</p>
        </div>

        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {menuItems.map(item => <Link key={item.title} to={item.path} className="group glass-card-interactive p-8 text-center hover:-translate-y-1 transition-all duration-micro block">
