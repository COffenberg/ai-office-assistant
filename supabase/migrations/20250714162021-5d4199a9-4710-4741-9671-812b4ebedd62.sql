-- Fix the ai_enhanced_search function ORDER BY ambiguity
...
BEGIN
  ...
  -- Fix ORDER BY ambiguity by using explicit column aliases
  ORDER BY (qa_relevance_score + qa_context_match + doc_relevance_score + doc_context_match) DESC, result_type ASC
  LIMIT limit_results;
END;
$$;